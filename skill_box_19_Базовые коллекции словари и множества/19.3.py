...
dictionary_values = data.values()
print('Список ключей ', list_of_keys, '\nСписок значений', dictionary_values)
...
# я нихуя не понял, надо добавлять новый ключ total_out
# или присваивать totalOut значение total_out
