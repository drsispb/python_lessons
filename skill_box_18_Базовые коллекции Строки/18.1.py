...
виде. Для этого ресторан любезно предоставил свой сайт, откуда можно получить актуальную информацию о меню в виде идущих
подряд названий.
...
actual_menu = menu.split(';')

print('Доступное меню: ', menu)
print('На данный момент в меню есть:', ', '.join(actual_menu))
