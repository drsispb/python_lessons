...
'''
# start_hour = 0
# corner_hour = float(input('Введите угол часовой стрелки: '))
# corner_minute = corner_hour * 12
# start_hour = int(corner_hour / 30)
# corner_minute = corner_minute - (360 * start_hour)
# print('Минутная стрелка повернулась на: ', corner_minute, 'градуса(-ов)')
...
'''
# while True:
#     a = float(input('Введите значение коэфициента а, a != 0: '))
#     b = float(input('Введите значение коэфициента b: '))
#     c = float(input('Введите значение коэфициента c: '))
#     x = 0
#     if a == 0:
#         print('Повторите ввод. а не должен быть равен 0')
#     else:
#         discr = b ** 2 - 4 * a * c
#         print('Диксриминант = ', discr)
#         break
# if discr > 0:
...
#     elif x2 > x1:
#         print('Первый корень: ', x2, 'Второй корень: ', x1)
# elif discr == 0:
#     x = -b / (2 * a)
