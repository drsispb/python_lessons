...
list_words = input('Введите текст:')
consonants = 'аоиеёэыуюя'
consonants_new = [i for i in list_words if i in consonants]

print('Список гласных букв: ', consonants_new)
print(len(consonants_new))